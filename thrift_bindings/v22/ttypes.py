...
class CfDef:
  ...
  thrift_spec = (
    ...
    (44, TType.STRING, 'cells_per_row_to_cache', None, "100", ), # 44
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.cells_per_row_to_cache = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 45:
        if ftype == TType.I32:
  ...
  def write(self, oprot):
    ...
    if self.cells_per_row_to_cache is not None:
      ...
      oprot.writeString(self.cells_per_row_to_cache)
      oprot.writeFieldEnd()
...
class MultiSliceRequest:
  ...
  thrift_spec = (
    ...
    (3, TType.LIST, 'column_slices', (TType.STRUCT,(ColumnSlice, ColumnSlice.thrift_spec)), None, ), # 3
